    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Create Field Agent</h3>
            ...
            <form class="" role="form">
                                    ...
                                    <div class="col-sm-4">
                                            <div class="form-group">
                                                <label for="" class="">Agent Name<span class="text-danger">*</span></label>
                                                <select name="" id="" class="form-control">
                                                    <option value="">Select Agent</option>
                                                    <option value="">Gabriel Grillo</option>
                                                    <option value="">Loveth Obi</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label for="" class="">Username<span class="text-danger">*</span></label>
